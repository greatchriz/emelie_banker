...
if (themeConfig.customizer) {
  ...
  <div class="z-[60] duration-500 ltr:right-0 rtl:left-0" id="customizer-wrapper">
    <aside
      id="customizer"
      class="w-[280px] 3xl:w-[336px] shadow-sm z-[52] duration-300 fixed ltr:right-0 rtl:left-0 h-full bg-n0  top-0 customizer-hide overflow-y-auto">
      <div
        class="p-4 flex justify-between items-center border-b border-n30 ">
        <div>
      ...
      <div class="p-4 border-b border-n30 ">
      ...
      <div class="p-4 border-b border-n30 ">
        ...
        <div class="flex gap-4 mb-6">
          <button
            class="flex items-center gap-2 px-4 py-2 rounded-lg ltr:bg-primary ltr:text-n0 bg-transparent border ltr:border-n30 "
            onclick="setLtr()">
            <span>LTR</span>
          </button>
          <button
            class="flex items-center gap-2 px-3 py-2 rounded-lg rtl:bg-primary rtl:text-n0 border border-n30 "
            onclick="setRtl()">
            <span>RTL</span>
          </button>
        </div>
...
const loadImg = () => {
  if (document.documentElement.classList.contains('dark')) {
    ...
    qrCodeImg && qrCodeImg.setAttribute('src', 'assets/images/qrcode.html');
  } else {
    logoFull.setAttribute('src', 'assets/images/logo-with-text-dark.html');
    logoFull2.setAttribute('src', 'assets/images/logo-with-text-dark.html');
    logoIcon.setAttribute('src', 'assets/images/logo-dark.html');
    logoText.setAttribute('src', 'assets/images/logo-text-dark.html');
    qrCodeImg && qrCodeImg.setAttribute('src', 'assets/images/qrcode-dark.html');
  }
};
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (isDarkMode) {
    ...
    logoFull2 && logoFull2.setAttribute('src', 'assets/images/logo-with-text-dark.html');
    qrCodeImg && qrCodeImg.setAttribute('src', 'assets/images/qrcode-dark.html');
  } else {
