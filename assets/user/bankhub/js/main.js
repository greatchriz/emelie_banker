...
const loadImg = () => {
  if (document.documentElement.classList.contains('dark')) {
    logoFull && logoFull.setAttribute('src', window.bankhubLogoFull || logoFull.getAttribute('src'));
    logoFull2 && logoFull2.setAttribute('src', window.bankhubLogoFull || logoFull2.getAttribute('src'));
    logoIcon && logoIcon.setAttribute('src', window.bankhubLogoIcon || logoIcon.getAttribute('src'));
    logoText && logoText.setAttribute('src', window.bankhubLogoText || logoText.getAttribute('src'));
  } else {
    logoFull && logoFull.setAttribute('src', window.bankhubLogoFull || logoFull.getAttribute('src'));
    logoFull2 && logoFull2.setAttribute('src', window.bankhubLogoFull || logoFull2.getAttribute('src'));
    logoIcon && logoIcon.setAttribute('src', window.bankhubLogoIcon || logoIcon.getAttribute('src'));
