...
const paymentDistributionChart = document.getElementById('payment-distribution-chart');
if (paymentDistributionChart) {
  const chartData = {
    ...
    labels: ['Credit Card', 'PayPal', 'Bank Transfer', 'Others'],
    colors: ['#4371E9', '#20B757', '#FFC861', '#8B5CF6'],
    legend: {
      show: false,
    },
    dataLabels: {
  ...
  const chart = new ApexCharts(paymentDistributionChart, chartData);
  chart.render();
}
...
if (revenueExpenseChart) {
  const chartData = {
    series: [
      ...
      {
        name: 'Expenses',
        data: [35000, 41000, 36000, 26000, 45000, 48000, 52000, 53000, 41000, 42000, 48000, 50000],
      },
    ],
    chart: {
      type: 'bar',
  ...
  const chart = new ApexCharts(revenueExpenseChart, chartData);
  chart.render();
}

// Loan Amortization Chart
const loanAmortizationChart = document.getElementById('loan-amortization-chart');
if (loanAmortizationChart) {
  const chartData = {
    series: [
      {
        name: 'Principal',
        data: [500, 520, 540, 565, 590, 620, 650, 685, 720, 760, 800, 845],
      },
      {
        name: 'Interest',
        data: [450, 430, 410, 385, 360, 330, 300, 265, 230, 190, 150, 105],
      },
    ],
    chart: {
      type: 'area',
  ...
  const chart = new ApexCharts(loanAmortizationChart, chartData);
  chart.render();
}

// Spending Trend Chart (Budgets Page)
...
if (spendingTrendChart) {
  const chartData = {
    series: [
      ...
      },
      {
        ...
        data: [4200, 3950, 4100, 3750, 3850, 3900],
      },
    ],
    chart: {
      type: 'line',
  ...
  const chart = new ApexCharts(spendingTrendChart, chartData);
  chart.render();
}

// Category Distribution Chart (Budgets Page)
const categoryDistributionChart = document.getElementById('category-distribution-chart');
if (categoryDistributionChart) {
  const chartData = {
    series: [30, 12, 8, 10, 6, 34],
    chart: {
      type: 'donut',
      height: 256,
    },
    labels: ['Housing', 'Food & Dining', 'Transportation', 'Shopping', 'Entertainment', 'Others'],
    colors: ['#4371E9', '#20B757', '#FFC861', '#4371E9', '#8B5CF6', '#E5E7EB'],
    legend: {
      show: false,
    },
    dataLabels: {
  ...
  const chart = new ApexCharts(categoryDistributionChart, chartData);
  chart.render();
}

// Portfolio Performance Chart (Investments Page)
const portfolioPerformanceChart = document.getElementById('portfolio-performance-chart');
if (portfolioPerformanceChart) {
  const chartData = {
    series: [
      {
        name: 'Portfolio Value',
        data: [200000, 205000, 210000, 215000, 220000, 225000, 230000, 235000, 238000, 240000, 243000, 245680],
      },
    ],
    chart: {
      type: 'area',
  ...
  const chart = new ApexCharts(portfolioPerformanceChart, chartData);
  chart.render();
}

// Asset Allocation Chart (Investments Page)
...
if (assetAllocationChart) {
  const chartData = {
    ...
    colors: ['#4371E9', '#20B757', '#FFC861', '#4371E9', '#8B5CF6'],
    legend: {
      show: false,
    },
    dataLabels: {
  ...
  const chart = new ApexCharts(assetAllocationChart, chartData);
  chart.render();
}
