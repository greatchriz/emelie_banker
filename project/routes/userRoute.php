...
Route::prefix('user')->group(function() {
    ...
    Route::group(['middleware' => ['otp','banuser']],function () {
      ...
      Route::group(['middleware'=>'kyc:Transfer'],function(){
        ...
        Route::get('tranfer-logs/{id}',[TransferLogController::class,'show'])->name('transfer.logs.show');
        Route::get('tranfer-logs/{id}/download',[TransferLogController::class,'download'])->name('transfer.logs.download');
