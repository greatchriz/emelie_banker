            ...
            <div class="container">
                <div class="row gy-5">
                    <div class="col-lg-5">
                        ...
                        <div class="contact__item" style="margin-top: 20px;">
                                <div class="contact__item-icon">
                                    <i class="fas fa-phone"></i>
                                </div>
                                <div class="contact__item-cont">
                                    <h6 class="contact__item-cont-title">@lang('Whatsapp') </h6>
                                    <a href="https://wa.link/78lwh5" class="text--base"> +1 (430) 252-4240 </a>
                                </div>
                        </div>
